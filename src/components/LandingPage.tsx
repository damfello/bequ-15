...
const BookOpenIcon = () => (
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className="text-indigo-400 text-4xl mb-4 mx-auto"
  >
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 to-gray-950 text-white selection:bg-indigo-500 selection:text-white">
      {/* Barra de Navegación */}
      <nav className="w-full p-4 sticky top-0 z-50 bg-gray-900/60 backdrop-blur-md border-b border-gray-700">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          <div className="space-x-4 md:space-x-6 flex items-center">
            ...
            <button onClick={navigateToLogin} className="bg-indigo-600 hover:bg-indigo-700 text-white px-3 py-1 md:px-4 md:py-2 rounded-md text-sm md:text-base font-medium transition duration-150 shadow-md"> Login / Sign Up </button>
          </div>
        </div>
      </nav>
      ...
      <section id="hero" className="pt-20 pb-16 md:pt-28 md:pb-24 px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <button onClick={() => handleScrollTo('pricing')} className="bg-indigo-600 hover:bg-indigo-700 text-white text-lg font-semibold px-8 py-3 rounded-md transition duration-150 shadow-lg mb-16"> View Plan Details </button>
          <div className="bg-gray-800/60 border border-gray-700/50 rounded-lg shadow-xl p-4 pt-8 relative max-w-2xl mx-auto text-left text-sm">
              ...
              <div className='space-y-3'>
                  <div className="flex justify-end"> <div className="bg-indigo-600 text-white px-3 py-1.5 rounded-lg rounded-br-none max-w-[70%]"> How can I classify a medical device? </div> </div>
                  ...
                  <div className="flex justify-end"> <div className="bg-indigo-600 text-white px-3 py-1.5 rounded-lg rounded-br-none max-w-[70%]"> What are the classification rules? </div> </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-gray-800/60 p-8 rounded-lg backdrop-blur-sm shadow-xl border border-gray-700/50">
            <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-3">
              <span className="text-4xl font-bold text-indigo-400">Easy to use</span>
              <span className="text-2xl text-gray-300">Self-explanatory</span>
              <span className="text-3xl font-semibold text-indigo-300">Time-saving</span>
              <span className="text-xl text-indigo-500">Easy access</span>
              <span className="text-3xl font-semibold text-gray-300">Clear Answers</span>
              <span className="text-2xl text-indigo-300">Simplified regulations</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="pricing" className="py-16 md:py-20 px-6">
        <div className="max-w-md mx-auto">
            ...
            <div className="bg-gray-800/80 rounded-lg shadow-2xl p-8 backdrop-blur-md border border-gray-700 transform transition duration-300 hover:scale-[1.02]">
               ...
               <button onClick={navigateToLogin} className="w-full bg-indigo-600 hover:bg-indigo-700 text-white text-lg font-semibold py-3 rounded-md transition duration-150 shadow-md"> Subscribe </button>
            </div>
          </div>
      </section>
