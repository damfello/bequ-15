...
export default function LandingPage() {
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-950 via-blue-900 to-indigo-950 text-white selection:bg-blue-500 selection:text-white">
      ...
      <nav className="w-full p-4 sticky top-0 z-50 bg-blue-950/80 backdrop-blur-md border-b border-white/10">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          <div className="space-x-4 md:space-x-6 flex items-center">
            <button onClick={() => scrollToSection('features')} className="text-sm md:text-base text-blue-200 hover:text-white transition duration-150">Features</button>
            <button onClick={() => scrollToSection('pricing')} className="text-sm md:text-base text-blue-200 hover:text-white transition duration-150">Pricing</button>
            <button
              onClick={navigateToLogin}
              className="bg-white text-blue-900 px-3 py-1 md:px-4 md:py-2 rounded-md text-sm md:text-base font-medium hover:bg-blue-100 transition duration-150 shadow"
            >
              Login / Sign Up
            </button>
          </div>
      ...
      <section id="hero" className="pt-20 pb-16 md:pt-28 md:pb-24 px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <button
            ...
            className="bg-blue-500 hover:bg-blue-600 text-white text-lg font-semibold px-8 py-3 rounded-md transition duration-150 shadow-lg mb-16"
          >
            Get Started Now
          </button>
          ...
          <div className="bg-gray-900/60 border border-blue-700/50 rounded-lg shadow-xl p-4 pt-8 relative max-w-2xl mx-auto text-left text-sm">
             ...
             <div className='space-y-3'>
                 ...
                 <div className="flex justify-end">
                     <div className="bg-blue-600 text-white px-3 py-1.5 rounded-lg rounded-br-none max-w-[70%]">
                         How Can I classify a Medical device?
                     </div>
                 </div>
                 {/* BeQu response placeholder */}
                  <div className="flex justify-start">
                     <div className="bg-gray-700 text-blue-100 px-3 py-1.5 rounded-lg rounded-bl-none max-w-[70%]">
                         To classify a medical device according to MDR (EU) 2017/745, you need to consider its intended purpose, duration of use, invasiveness, and whether it's an active device... [more details]
                     </div>
                 </div>
                 {/* Another user message */}
                 <div className="flex justify-end">
                     <div className="bg-blue-600 text-white px-3 py-1.5 rounded-lg rounded-br-none max-w-[70%]">
                         What are the rules for classifying?
                     </div>
                 </div>
                  {/* BeQu thinking placeholder */}
                  <div className="flex justify-start">
                     <div className="bg-gray-700 text-blue-300 italic px-3 py-1.5 rounded-lg rounded-bl-none max-w-[70%]">
                         Looking up MDR Annex VIII classification rules...
                     </div>
                 </div>
             </div>
          </div>
         ...
         <div className="max-w-md mx-auto">
            ...
            <div className="bg-gray-900/80 rounded-lg shadow-2xl p-8 backdrop-blur-md border border-gray-700 transform transition duration-300 hover:scale-[1.02]">
               ...
               <button
                  ...
                  className="w-full bg-blue-500 hover:bg-blue-600 text-white text-lg font-semibold py-3 rounded-md transition duration-150 shadow-md"
               >
      ...
      {/* Authentication Section (Target for scroll) */}
      <section id="auth" className="py-16 md:py-20 px-6">
        {/* This section now primarily serves as a scroll target */}
         {/* The actual AuthUI is on the /login page */}
         {/* Optionally add a small prompt here */}
          <div className="max-w-md mx-auto text-center">
              ...
              <button
                onClick={navigateToLogin}
                className="bg-white text-blue-900 px-6 py-3 rounded-md text-base font-medium hover:bg-blue-100 transition duration-150 shadow"
              >
                  Login / Sign Up
              </button>
          </div>
