...
const BookOpenIcon = () => (
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className="text-cyan-400 text-4xl mb-4 mx-auto"
  >
    ...
    <div className="border-b border-gray-700/50 py-4">
      ...
      >
        <div className="overflow-hidden">
          <p className="pt-4 pr-6 text-gray-400 leading-relaxed">
            {answer}
          </p>
        </div>
      </div>
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-bequ-pattern text-white selection:bg-cyan-500 selection:text-white">
      {/* Superposición semitransparente para legibilidad */}
      <div className="min-h-screen bg-gray-950/70 backdrop-blur-sm">
        {/* Barra de Navegación */}
        <nav className="w-full p-4 sticky top-0 z-50 bg-gray-900/60 backdrop-blur-md border-b border-gray-700">
          <div className="max-w-6xl mx-auto flex justify-between items-center">
            <span className="text-xl font-bold tracking-tight text-white">BeQu | Medical Regulations AI Assistant</span>
            <div className="space-x-4 md:space-x-6 flex items-center">
              <button onClick={() => handleScrollTo('features')} className="text-sm md:text-base text-gray-300 hover:text-white transition duration-150">Features</button>
              <button onClick={() => handleScrollTo('pricing')} className="text-sm md:text-base text-gray-300 hover:text-white transition duration-150">Pricing</button>
              <button onClick={() => handleScrollTo('faq')} className="text-sm md:text-base text-gray-300 hover:text-white transition duration-150">FAQ</button>
              <button onClick={navigateToLogin} className="bg-cyan-600 hover:bg-cyan-700 text-white px-3 py-1 md:px-4 md:py-2 rounded-md text-sm md:text-base font-medium transition duration-150 shadow-md"> Login / Sign Up </button>
            </div>
          </div>
        </nav>
        ...
        <section id="hero" className="pt-20 pb-16 md:pt-28 md:pb-24 px-6 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <button onClick={() => handleScrollTo('pricing')} className="bg-cyan-600 hover:bg-cyan-700 text-white text-lg font-semibold px-8 py-3 rounded-md transition duration-150 shadow-lg mb-16"> View Plan Details </button>
            <div className="bg-gray-800/60 border border-gray-700/50 rounded-lg shadow-xl p-4 pt-8 relative max-w-2xl mx-auto text-left text-sm">
                ...
                <div className='space-y-3'>
                    <div className="flex justify-end"> <div className="bg-cyan-600 text-white px-3 py-1.5 rounded-lg rounded-br-none max-w-[70%]"> How can I classify a medical device? </div> </div>
                    <div className="flex justify-start"> <div className="bg-gray-700 text-gray-200 px-3 py-1.5 rounded-lg rounded-bl-none max-w-[70%]"> To classify a medical device according to MDR (EU) 2017/745, you need to consider its intended purpose... [more details] </div> </div>
                    <div className="flex justify-end"> <div className="bg-cyan-600 text-white px-3 py-1.5 rounded-lg rounded-br-none max-w-[70%]"> What are the classification rules? </div> </div>
                    <div className="flex justify-start"> <div className="bg-gray-700 text-gray-400 italic px-3 py-1.5 rounded-lg rounded-bl-none max-w-[70%]"> Looking up MDR Annex VIII classification rules... </div> </div>
                </div>
            </div>
          </div>
        </section>
        ...
        {/* Sección Features */}
        <section id="features" className="py-16 md:py-20 px-6 bg-gray-900/50">
          <div className="max-w-6xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-16">The Compliance Advantage</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
              <div className="bg-gray-800/50 p-6 rounded-lg text-center backdrop-blur-sm transform transition duration-300 hover:scale-105 hover:bg-gray-700/50">
                 <BookOpenIcon />
                 <h3 className="text-xl font-semibold mb-2">Regulatory Knowledge</h3>
                 <p className="text-gray-300 text-sm leading-relaxed">Access updated guidance on official medical regulations. Our AI is trained to interpret complex compliance documents to provide quick, accurate answers.</p>
              </div>
              <div className="bg-gray-800/50 p-6 rounded-lg text-center backdrop-blur-sm transform transition duration-300 hover:scale-105 hover:bg-gray-700/50">
                 <CpuIcon />
                 <h3 className="text-xl font-semibold mb-2">Advanced AI Processing</h3>
                 <p className="text-gray-300 text-sm leading-relaxed">Leverages powerful language models for deep understanding of medical device regulations. Delivers context-aware responses tailored to your specific queries.</p>
               </div>
              <div className="bg-gray-800/50 p-6 rounded-lg text-center backdrop-blur-sm transform transition duration-300 hover:scale-105 hover:bg-gray-700/50">
                 <LockIcon />
                 <h3 className="text-xl font-semibold mb-2">Security & Privacy</h3>
                 <p className="text-gray-300 text-sm leading-relaxed">All data is encrypted and handled in compliance with industry standards. Your sensitive information stays confidential and protected at every step.</p>
               </div>
            </div>
          </div>
        </section>
        ...
        <section id="testimonials" className="py-16 md:py-20 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-gray-800/60 p-8 rounded-lg backdrop-blur-sm shadow-xl border border-gray-700/50">
              <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-3">
                <span className="text-4xl font-bold text-cyan-400">Easy to use</span>
                <span className="text-2xl text-gray-300">Self-explanatory</span>
                <span className="text-3xl font-semibold text-cyan-300">Time-saving</span>
                <span className="text-xl text-cyan-500">Easy access</span>
                <span className="text-3xl font-semibold text-gray-300">Clear Answers</span>
                <span className="text-2xl text-cyan-300">Simplified regulations</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="pricing" className="py-16 md:py-20 px-6">
          <div className="max-w-md mx-auto">
              ...
              <div className="bg-gray-800/80 rounded-lg shadow-2xl p-8 backdrop-blur-md border border-gray-700 transform transition duration-300 hover:scale-[1.02]">
                 <h3 className="text-xl font-semibold mb-2 text-center text-gray-200"> Standard Plan </h3>
                 <p className="text-4xl font-bold my-3 text-center text-white">€35 <span className="text-lg font-normal text-gray-300">/ month</span></p>
                 <ul className="space-y-3 my-6 text-gray-300 text-sm">
                 ...
                 <button onClick={navigateToLogin} className="w-full bg-cyan-600 hover:bg-cyan-700 text-white text-lg font-semibold py-3 rounded-md transition duration-150 shadow-md"> Subscribe </button>
              </div>
            </div>
        </section>
        ...
        <section id="auth" className="py-16 md:py-20 px-6">
            <div className="max-w-md mx-auto text-center">
                ...
                <p className="text-gray-300 mb-6">Create an account or log in to subscribe and access BeQu AI.</p>
                <button onClick={navigateToLogin} className="bg-white text-gray-900 px-6 py-3 rounded-md text-base font-medium hover:bg-gray-200 transition duration-150 shadow-md"> Login / Sign Up </button>
            </div>
        </section>

        {/* Footer */}
        <footer className="w-full max-w-6xl mx-auto mt-12 mb-6 pt-6 border-t border-gray-700/50 text-center text-gray-400 text-sm">
